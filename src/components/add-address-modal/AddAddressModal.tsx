...
import type { BaseAddressDraft } from '../../services/interfaces';
import { countries } from '../../utils/country';
import { validationAddressSchema } from '../change-address-modal/validationSchema';

interface AddressModalProps {
  onClose: () => void;
  onSave: (values: BaseAddressDraft) => void;
  onRegistrationSuccess: () => void;
}

const AddAddressModal: React.FC<AddressModalProps> = ({ onClose, onSave, onRegistrationSuccess }) => {
  return (
    <div>
      <h3 className="modal-title">Change address</h3>
      <Formik
        initialValues={{ streetName: '', city: '', postalCode: '', country: '' }}
